...
model = dict(
    ...
    teacher_bbox_head=dict(
        ...
        loss_bbox=dict(
            ...
            loss_weight=2.5,
            return_iou=False)),
    teacher_ckpt='/home/ubuntu/mmyolo/work_dirs/body_detect/yolov6_m_s_structure_coco_halfperson/epoch_120.pth',
...
load_from = './work_dirs/body_detect/yolov6_t_shallow_s_v8_data_aug_coco_halfperson_4cls/epoch_120.pth'
work_dir = './work_dirs/body_detect/lad_yolov6_m_s_structure_distill_yolov6_t_shallow_s_v8_dataaug_coco_halfperson_4cls'
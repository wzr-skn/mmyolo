...
class LAD_YOLOv6Head(YOLOv6Head):
    ...
    def loss_by_feat(
        ...
        assigned_bboxes = label_assignment_results['assigned_bboxes']
        assigned_scores = label_assignment_results['assigned_scores']
        fg_mask_pre_prior = label_assignment_results['fg_mask_pre_prior']
